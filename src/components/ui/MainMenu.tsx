...
export default function MainMenu({ onPlay, onCreateCharacter, onSignOut, onDelete, characters }: MainMenuProps) {
  ...
  return (
    <div className="absolute inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-20">
      <div className="text-center text-white w-full max-w-4xl">
        ...
        <button onClick={() => setView('start')} className="block mx-auto text-xl hover:text-cyan-400 transition-colors mt-12">
          Back
        </button>
      </div>
    </div>
